...
//    }
    ...
    public Result verifyLogin(UserLogin userLogin) {
        ...
        String machUse = userLogin.getEmail() + userLogin.getPassword() + SystemSecretKey.PASSWORD_SECRET_KEY.getValue();
        ...
        String token = JwtToken.generateToken(userLogin.getEmail(), ROLE.ROLE_USER);
...
//    @Async("taskExecutor")
    public Result registration(String email, String password, String firstname, String lastname){
        ...
        String passwordToken = passwordEncoder.encode(email + password + SystemSecretKey.PASSWORD_SECRET_KEY.getValue());
...
//            userMapper.saveANewUser(userNew);
            ...
            return new Result(200, "Registration successful! The verification link will be " +
                    "sent to your E-mail box.", 0L, null, null);
        }
        else
        {
