      ...
      <el-table-column prop="operation" label="OPERATE">
        <template slot-scope="scope">
          <div class="button-container">
            <el-button class="button-spacing" size="small" type="success" @click="openDialog(scope.row)">EDIT
            </el-button>
            <el-button class="button-spacing" size="small" type="danger" @click="confirmDelete(scope.row)">DELETE</el-button>
